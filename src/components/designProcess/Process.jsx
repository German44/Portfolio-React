const Process = ({ title, content, image }) => {
  return (
    <div className="w-full h-full px-8 mt-4 flex flex-col sm:grid sm:grid-cols-4 sm:grid-rows-6 gap-4 ">
      ...
      <div className=" sm:col-span-2 sm:row-span-2 sm:col-start-3 ">
        <p className="text-white  text-lg sm:text-xl text-justify m-4">{content}</p>
      </div>
